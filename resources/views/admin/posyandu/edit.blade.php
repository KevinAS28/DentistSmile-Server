<div class="modal fade" id="modal-edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal" id="posyandu-edit" method="post" enctype="multipart/form-data" files=true>  
            @method('PUT')
            @csrf      
...
<script type="text/javascript">
    $(document).ready(function () {
        /* save data */
        $('#posyandu-edit').on('submit', function (e) {
      e.preventDefault();
        $.ajax({
            'type': 'post',
            'url' : "{{ url('admin/posyandu') }}"+"/"+$('input[name=id_edit]').val(),
