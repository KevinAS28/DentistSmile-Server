                ...
                <form action="{{route('orangtua.updateprofil')}}" class="forms-horizontal"  method="post" enctype="multipart/form-data" files=true>   
                    ...
                    <div class="form-group">
                        <div class="mt-5">
                            ...
                            <option value="SD" {{$user->profilorangtua->pendidikan=="SD" ? 'selected' : ''}}>SD</option>
                            <option value="SMP"{{$user->profilorangtua->pendidikan=="SMP" ? 'selected' : ''}}>SMP</option>
                            <option value="SMA"{{$user->profilorangtua->pendidikan=="SMA" ? 'selected' : ''}}>SMA/SMK</option>
                            <option value="D1" {{$user->profilorangtua->pendidikan=="D1" ? 'selected' : ''}}>D1</option>
                            <option value="D2" {{$user->profilorangtua->pendidikan=="D2" ? 'selected' : ''}}>D2</option>
                            <option value="D3" {{$user->profilorangtua->pendidikan=="D3" ? 'selected' : ''}}>D3</option>
                            <option value="D4" {{$user->profilorangtua->pendidikan=="D4" ? 'selected' : ''}}>D4</option>
                            <option value="S1" {{$user->profilorangtua->pendidikan=="S1" ? 'selected' : ''}}>S1</option>
                            <option value="S2" {{$user->profilorangtua->pendidikan=="S2" ? 'selected' : ''}}>S2</option>
                            <option value="S3" {{$user->profilorangtua->pendidikan=="S3" ? 'selected' : ''}}>S3</option>
                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3">
